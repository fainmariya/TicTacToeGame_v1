...
e = Entry()
e.pack()
e.bind("<KeyRelease>", lambda p: print ("Key release: ", p))
e.bind("<FocusOut>", lambda p: print ("FocusOut: ", p))
e.bind("<Leave>", lambda p: print ("Mouse leave: ", p))
e.bind("<Enter>", lambda p: print ("ENTER pressed: ", p))
e.bind("<Button-1>", lambda p: print ("Left mouse button pressed pressed: ", p.widget.get()))
Entry().pack()
w.mainloop()
